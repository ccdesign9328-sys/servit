        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                { href: "/service/hvac-system", label: "Cámaras de Seguridad" },
                {
                  href: "/service/video-portero-inteligente",
                  label: "Video Portero Inteligente",
                },
                {
                  href: "/service/cool-comfort-deal",
                  label: "Aire Acondicionado",
                },
                { href: "/service/cerca-elec", label: "Cerca Eléctrica" },
                {
                  href: "/service/ac-installation",
                  label: "Control de Acceso",
                },
                {
                  href: "/service/air-quality-solutions",
